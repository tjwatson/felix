...
public class FELIX_5255_Test extends TestCase {

    @Test
    public void testResolution() throws Exception {
        BufferedReader reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/felix-5255.json")));
        ...
        for (Resource resource : repository) {
            String sn = Util.getSymbolicName(resource);
            if (sn.startsWith("test.z")) {
